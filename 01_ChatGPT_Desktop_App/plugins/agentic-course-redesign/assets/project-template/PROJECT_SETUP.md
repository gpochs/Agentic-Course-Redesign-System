...
This folder is for one course only. It was created from the Agentic Course Redesign plugin without activating the runtime.
...
4. Ask the orchestrator to inventory the files and prepare Gate 0.
